...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Comunicate con Lessa') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/logoapp.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/logoapp.png">
        ...
        <div class="fixed-plugin">
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="header-title"> Colores para la barra Lateral</li>
              ...
              <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('material') }}/img/fondo1.png" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('material') }}/img/fondo2.png" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('material') }}/img/fondo3.png" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('material') }}/img/fondo4.png" alt="">
                </a>
              </li>
