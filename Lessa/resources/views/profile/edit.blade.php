          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Información del Usuario') }}</h4>
                <!-- <p class="card-category">{{ __('Complete todos los campos') }}</p> -->
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('telefono') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" id="input-telefono" type="telefno" placeholder="{{ __('Telefono') }}" value="{{ old('telefono', auth()->user()->telefono) }}" required />
                      @if ($errors->has('email'))
